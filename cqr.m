function [k,v] = cqr(A,B,Q,R,N,degree,solver,verbose)
...
%%
  ...
  if ( degree>2 )
    ...
    %  Form the Kronecker product terms involving K{#}
    tmp =-k{2}.'*R*k{2};
    bb  = tmp(:);   clear tmp

    bb = bb - LyapProduct((B*k{2}+N{2}).',v3,3) ...
  ...
  if ( degree>3 )
    ...
    bb = bb - LyapProduct((B*k{2}+N{2}).',v4,4) ...
            - LyapProduct((B*k{3}+N{3}).',v3,3);
  ...
  if ( degree>4 )
    ...
    bb = bb - LyapProduct((B*k{2}+N{2}).',v5,5) ...
            - LyapProduct((B*k{3}+N{3}).',v4,4) ...
            - LyapProduct((B*k{4}     ).',v3,3);
  ...
  if ( degree>5 )
    ...
    % augment with the Kronecker sum products
    bb = bb - LyapProduct((B*k{2}+N{2}).',v6,6) ...
            - LyapProduct((B*k{3}+N{3}).',v5,5) ...
            - LyapProduct((B*k{4}     ).',v4,4) ...
            - LyapProduct((B*k{5}     ).',v3,3);
       
    v7 = solveKroneckerSystem(Al,bb,n,7,solver);
    v7 = real(v7(:));
    
    v7 = kronMonomialSymmetrize(v7,n,7);
  ...
  if ( degree>6 )
    ...
    % augment with the Kronecker sum products
    bb = bb - LyapProduct((B*k{2}+N{2}).',v7,7) ...
            - LyapProduct((B*k{3}+N{3}).',v6,6) ...
            - LyapProduct((B*k{4}     ).',v5,5) ...
            - LyapProduct((B*k{5}     ).',v4,4) ...
            - LyapProduct((B*k{6}     ).',v3,3);
