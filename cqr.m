...
%%
  ...
  if ( degree>2 )
    ...
    bb = bb - LyapProduct((B*K2+N{2}).',v3,3) ...
  ...
  if ( degree>3 )
    ...
    bb = bb - LyapProduct((B*K2+N{2}).',v4,4) ...
  ...
  if ( degree>4 )
    ...
    bb = bb - LyapProduct((B*K2+N{2}).',v5,5) ...
  ...
  if ( degree>5 )
    ...
    % augment with the Kronecker sum products
    bb = bb - LyapProduct((B*K2+N{2}).',v6,6) ...
  ...
  if ( degree>6 )
    ...
    % augment with the Kronecker sum products
    bb = bb - LyapProduct((B*K2+N{2}).',v7,7) ...
